...
class AboutComprehension(Koan):
    ...
    def test_filtering_lists_with_list_comprehensions(self):
        ...
        self.assertEqual(3, len(comprehension)) #number of words(delicacy items) in feast that have more than 6 characters
    ...
    def test_double_list_comprehension(self):
        ...
        self.assertEqual(6, len(comprehension)) # treat like matrix [2x3]
