...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        self.assertEqual({'MacLeod', 'Malcolm', 'Ramirez', 'Matunas'}, there_can_only_be_only_one) #curly braces for sets, order doesn't matter
    ...
    def test_convert_the_set_into_a_list_to_sort_it(self):
        self.assertEqual(list(['1', '2', '3', '4', '5']), sorted(set('12345')))
